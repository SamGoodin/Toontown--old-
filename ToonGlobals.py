...
Phase3AnimList = ['neutral', 'run']
Phase3_5AnimList = ['walk', 'teleport', 'book', 'jump', 'running-jump', 'jump-zstart', 'jump-zhang', 'jump-zend',
                     'leap_zstart', 'leap_zhang', 'leap_zend', 'press-button', 'pie-throw', 'victory-dance',
                     'sidestep-left', 'conked', 'cringe', 'wave', 'shrug', 'angry', 'tutorial-neutral', 'left-point',
                     'right-point', 'right-point-start', 'give-props', 'give-props-start', 'right-hand',
                     'right-hand-start', 'duck', 'jump-back-right', 'periscope']
Phase4AnimList = ['sit', 'intoSit', 'swim', 'tug-o-war', 'losewalk', 'sad-neutral', 'up', 'down', 'left', 'right',
                  'applause', 'confused', 'bow', 'curtsy', 'bored', 'think', 'fish', 'cast', 'castlong', 'fishEND',
                  'fishneutral', 'fishAGAIN', 'reel', 'reelH', 'reelneutral', 'pole', 'poleneutral', 'slip-forward',
                  'slip-backward', 'gameneutral', 'gamerun', 'eat_neutral', 'eatnrun', 'gameThrow', 'swing', 'petin',
                  'petloop', 'petend', 'scientistJealous', 'scientistEmcee', 'scientistWork', 'scientistGame']
Phase5AnimList = ['water-gun', 'hold-bottle', 'firehose', 'spit', 'tickle', 'smooch', 'happy-dance', 'sprinkle-dust',
                  'juggle', 'climb', 'shout', 'toss', 'hold-magnet', 'hypnotize', 'struggle', 'lose', 'melt']
Phase5_5AnimList = ['takePhone', 'phoneNeutral', 'phoneBack', 'jellybeanJar', 'callPet', 'feedPet', 'into_dig',
                    'loop-dig', 'water']
Phase6AnimList = ['headdown-putt', 'into-putt', 'loop-putt', 'rotateL-putt', 'rotateR-putt', 'swing-putt',
                  'look-putt', 'lookloop-putt', 'bad-putt', 'badloop-putt', 'good-putt']
Phase9AnimList = ['push']
Phase10AnimList = ['leverReach', 'leverPull', 'leverNeutral']

PhaseAnimsDict = {'phase_3.mf': Phase3AnimList,
     'phase_3.5.mf': Phase3_5AnimList,
     'phase_4.mf': Phase4AnimList,
     'phase_5.mf': Phase5AnimList,
     'phase_5.5.mf': Phase5_5AnimList,
     'phase_6.mf': Phase6AnimList,
     'phase_9.mf': Phase9AnimList,
     'phase_10.mf': Phase10AnimList}
...
allAnimalsList = ["dog", "cat", "mouse", "rabbit", "horse", "pig", "monkey", "duck", "bear"]

dogHeads = ["phase_3/models/char/tt_a_chr_dgl_shorts_head_1000", "phase_3/models/char/tt_a_chr_dgm_shorts_head_1000",
            "phase_3/models/char/tt_a_chr_dgm_skirt_head_1000", "phase_3/models/char/tt_a_chr_dgs_shorts_head_1000"]

DogMuzzleDict = {'ls': '/models/char/dogMM_Shorts-headMuzzles-',
 'ss': '/models/char/dogMM_Skirt-headMuzzles-',
 'sl': '/models/char/dogSS_Shorts-headMuzzles-',
 'll': '/models/char/dogLL_Shorts-headMuzzles-'}

EyelashDict = {'dog': '/models/char/dog-lashes',
 'cat': '/models/char/cat-lashes',
 'horse': '/models/char/horse-lashes',
 'mouse': '/models/char/mouse-lashes',
 'rabbit': '/models/char/rabbit-lashes',
 'duck': '/models/char/duck-lashes',
 'monkey': '/models/char/monkey-lashes',
 'bear': '/models/char/bear-lashes',
 'pig': '/models/char/pig-lashes'}
